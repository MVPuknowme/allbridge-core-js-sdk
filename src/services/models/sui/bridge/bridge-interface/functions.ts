...
export function swapAndBridge(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::swap_and_bridge`,
...
export function receiveTokens(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::receive_tokens`,
    typeArguments: [typeArg],
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
...
export function swapAndBridgeWormhole(
  tx: Transaction,
  typeArg: string,
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::swap_and_bridge_wormhole`,
    typeArguments: [typeArg],
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
...
export function receiveTokensWormhole(
  tx: Transaction,
  typeArg: string,
  args: ReceiveTokensWormholeArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::receive_tokens_wormhole`,
    typeArguments: [typeArg],
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
...
export function swap(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::swap`,
...
export function migrate(tx: Transaction, args: MigrateArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::migrate`,
...
export function stopDeposit(
  tx: Transaction,
  typeArg: string,
  args: StopDepositArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::stop_deposit`,
    typeArguments: [typeArg],
...
export function startDeposit(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::start_deposit`,
    typeArguments: [typeArg],
    arguments: [obj(tx, args.adminCap), obj(tx, args.bridge)],
  });
}
...
export function addBridge(tx: Transaction, args: AddBridgeArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::add_bridge`,
    arguments: [
...
export function removeBridge(
  tx: Transaction,
  args: RemoveBridgeArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::remove_bridge`,
...
export function addBridgeToken(
  tx: Transaction,
  args: AddBridgeTokenArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::add_bridge_token`,
...
export function removeBridgeToken(
  tx: Transaction,
  args: RemoveBridgeTokenArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::remove_bridge_token`,
    arguments: [obj(tx, args.adminCap), obj(tx, args.bridge), pure(tx, args.chainId, `u8`), obj(tx, args.tokenAddress)],
  });
}
...
export function depositFee(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::deposit_fee`,
    typeArguments: [typeArg],
...
export function withdrawFee(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::withdraw_fee`,
    typeArguments: [typeArg],
...
export function setGasUsage(tx: Transaction, args: SetGasUsageArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::set_gas_usage`,
    arguments: [
      obj(tx, args.adminCap),
      obj(tx, args.bridge),
      pure(tx, args.chainId, `u8`),
...
export function addPool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::add_pool`,
    typeArguments: [typeArg],
...
export function setRebalancer(
  tx: Transaction,
  args: SetRebalancerArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::set_rebalancer`,
...
export function gasUsage(tx: Transaction, args: GasUsageArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::gas_usage`,
...
export function canSwap(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::can_swap`,
...
export function feeValue(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::fee_value`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}

export function adminFeeShareBp(
  tx: Transaction,
  typeArg: string,
  bridge: TransactionObjectInput,
  options?: { env?: EnvConfig }
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::admin_fee_share_bp`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function getBridgeCost(
  tx: Transaction,
  args: GetBridgeCostArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::get_bridge_cost`,
...
export function getBridgeAllbridgeCost(
  tx: Transaction,
  args: GetBridgeAllbridgeCostArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::get_bridge_allbridge_cost`,
...
export function getBridgeWormholeCost(
  tx: Transaction,
  args: GetBridgeWormholeCostArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::get_bridge_wormhole_cost`,
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
      obj(tx, args.wormholeState),
...
export function isProcessedMessage(
  tx: Transaction,
  args: IsProcessedMessageArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::is_processed_message`,
...
export function deposit(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::deposit`,
    typeArguments: [typeArg],
...
export function claimReward(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::claim_reward`,
    typeArguments: [typeArg],
...
export function withdraw(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::withdraw`,
    typeArguments: [typeArg],
...
export function pool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function poolBalance(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_balance`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function poolDecimals(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_decimals`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}

export function poolTokenBalance(
  tx: Transaction,
  typeArg: string,
  bridge: TransactionObjectInput,
  options?: { env?: EnvConfig }
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_token_balance`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}

export function poolVusdBalance(
  tx: Transaction,
  typeArg: string,
  bridge: TransactionObjectInput,
  options?: { env?: EnvConfig }
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_vusd_balance`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}

export function poolD(
  tx: Transaction,
  typeArg: string,
  bridge: TransactionObjectInput,
  options?: { env?: EnvConfig }
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_d`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}

export function poolA(
  tx: Transaction,
  typeArg: string,
  bridge: TransactionObjectInput,
  options?: { env?: EnvConfig }
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_a`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function canDeposit(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::can_deposit`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function canWithdraw(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::can_withdraw`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function feeShare(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::fee_share`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}

export function poolLpSupply(
  tx: Transaction,
  typeArg: string,
  bridge: TransactionObjectInput,
  options?: { env?: EnvConfig }
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_lp_supply`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function poolPendingRewards(
  tx: Transaction,
  typeArg: string,
  args: PoolPendingRewardsArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::pool_pending_rewards`,
    typeArguments: [typeArg],
    arguments: [obj(tx, args.bridge), obj(tx, args.userDeposit)],
  });
}
...
export function newPool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::new_pool`,
    typeArguments: [typeArg],
    arguments: [
      obj(tx, args.adminCap),
...
export function setFeeShare(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::set_fee_share`,
    typeArguments: [typeArg],
...
export function setBalanceRatioMinBp(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::set_balance_ratio_min_bp`,
    typeArguments: [typeArg],
...
export function stopSwap(tx: Transaction, args: StopSwapArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::stop_swap`,
...
export function startSwap(tx: Transaction, args: StartSwapArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::start_swap`,
    arguments: [obj(tx, args.adminCap), obj(tx, args.bridge)],
  });
}
...
export function stopWithdraw(
  tx: Transaction,
  typeArg: string,
  args: StopWithdrawArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::stop_withdraw`,
    typeArguments: [typeArg],
    arguments: [obj(tx, args.stopCap), obj(tx, args.bridge)],
  });
}
...
export function startWithdraw(
  tx: Transaction,
  typeArg: string,
  args: StartWithdrawArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::start_withdraw`,
    typeArguments: [typeArg],
    arguments: [obj(tx, args.adminCap), obj(tx, args.bridge)],
  });
}
...
export function adjustTotalLpAmount(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::adjust_total_lp_amount`,
    typeArguments: [typeArg],
...
export function setAdminFeeShareBp(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::set_admin_fee_share_bp`,
    typeArguments: [typeArg],
...
export function claimAdminFee(
  tx: Transaction,
  typeArg: string,
  args: ClaimAdminFeeArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::claim_admin_fee`,
    typeArguments: [typeArg],
    arguments: [obj(tx, args.adminCap), obj(tx, args.bridge)],
  });
}

export function newUserDeposit(tx: Transaction, typeArg: string, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::new_user_deposit`,
    typeArguments: [typeArg],
    arguments: [],
  });
}
...
export function destroyEmpty(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::destroy_empty`,
    typeArguments: [typeArg],
...
export function lpAmount(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::lp_amount`,
    typeArguments: [typeArg],
    arguments: [obj(tx, userDeposit)],
  });
}
...
export function rewardDebt(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge_interface::reward_debt`,
    typeArguments: [typeArg],
    arguments: [obj(tx, userDeposit)],
  });
}
