...
export function init(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::init`,
    arguments: [],
  });
}
...
export function migrate(tx: Transaction, args: MigrateArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::migrate`,
...
export function swapAndBridgeAllbridge(
  tx: Transaction,
  typeArg: string,
  args: SwapAndBridgeAllbridgeArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::swap_and_bridge_allbridge`,
...
export function swapAndBridgeWormhole(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::swap_and_bridge_wormhole`,
    typeArguments: [typeArg],
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
...
export function receiveTokensAllbridge(
  tx: Transaction,
  typeArg: string,
  args: ReceiveTokensAllbridgeArgs,
  options?: { env?: EnvConfig }
): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::receive_tokens_allbridge`,
    typeArguments: [typeArg],
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
...
export function receiveTokensWormhole(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::receive_tokens_wormhole`,
    typeArguments: [typeArg],
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
...
export function swap(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::swap`,
...
export function getId(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::get_id`,
...
export function stopSwap(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::stop_swap`,
    arguments: [obj(tx, bridge)],
  });
}
...
export function startSwap(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::start_swap`,
    arguments: [obj(tx, bridge)],
  });
}
...
export function addBridge(tx: Transaction, args: AddBridgeArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::add_bridge`,
...
export function removeBridge(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::remove_bridge`,
...
export function addBridgeToken(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::add_bridge_token`,
...
export function removeBridgeToken(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::remove_bridge_token`,
    arguments: [obj(tx, args.bridge), pure(tx, args.chainId, `u8`), obj(tx, args.tokenAddress)],
  });
}
...
export function depositFee(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::deposit_fee`,
    typeArguments: [typeArg],
...
export function withdrawFee(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::withdraw_fee`,
    typeArguments: [typeArg],
...
export function setGasUsage(tx: Transaction, args: SetGasUsageArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::set_gas_usage`,
...
export function addPool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::add_pool`,
    typeArguments: [typeArg],
...
export function setRebalancer(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::set_rebalancer`,
...
export function getVersion(tx: Transaction, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::get_version`,
    arguments: [],
  });
}
...
export function canSwap(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::can_swap`,
    arguments: [obj(tx, bridge)],
  });
}
...
export function feeValue(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::fee_value`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function adminFeeShareBp(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::admin_fee_share_bp`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function pool(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::pool`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}

export function poolMut(
  tx: Transaction,
  typeArg: string,
  bridge: TransactionObjectInput,
  options?: { env?: EnvConfig }
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::pool_mut`,
    typeArguments: [typeArg],
    arguments: [obj(tx, bridge)],
  });
}
...
export function gasUsage(tx: Transaction, args: GasUsageArgs, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::gas_usage`,
    arguments: [obj(tx, args.bridge), pure(tx, args.chainId, `u8`)],
  });
}
...
export function getBridgeCost(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::get_bridge_cost`,
...
export function isProcessedMessage(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::is_processed_message`,
...
export function getBridgeAllbridgeCost(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::get_bridge_allbridge_cost`,
...
export function getBridgeWormholeCost(
  ...
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::get_bridge_wormhole_cost`,
    arguments: [
      obj(tx, args.bridge),
      obj(tx, args.messenger),
      obj(tx, args.wormholeState),
...
export function getPoolKey(tx: Transaction, typeArg: string, options?: { env?: EnvConfig }): TransactionResult {
  return tx.moveCall({
    target: `${getPublishedAt("bridge", options?.env)}::bridge::get_pool_key`,
    typeArguments: [typeArg],
    arguments: [],
  });
}
