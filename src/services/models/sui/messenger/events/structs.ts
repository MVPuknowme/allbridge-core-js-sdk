...
export function isMessageSentEvent(type: string): boolean {
  ...
  return type === `${getTypeOrigin("messenger", "events::MessageSentEvent")}::events::MessageSentEvent`;
}
...
export class MessageSentEvent implements StructClass {
  ...
  static get $typeName(): `${string}::events::MessageSentEvent` {
    return `${getTypeOrigin("messenger", "events::MessageSentEvent")}::events::MessageSentEvent` as const;
  }
...
export function isMessageReceivedEvent(type: string): boolean {
  type = compressSuiType(type);
  return type === `${getTypeOrigin("messenger", "events::MessageReceivedEvent")}::events::MessageReceivedEvent`;
}
...
export class MessageReceivedEvent implements StructClass {
  ...
  static get $typeName(): `${string}::events::MessageReceivedEvent` {
    return `${getTypeOrigin("messenger", "events::MessageReceivedEvent")}::events::MessageReceivedEvent` as const;
  }
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
