...
export function isWormholeMessage(type: string): boolean {
  ...
  return type === `${getTypeOrigin("wormhole", "publish_message::WormholeMessage")}::publish_message::WormholeMessage`;
}
...
export class WormholeMessage implements StructClass {
  ...
  readonly $typeName: typeof WormholeMessage.$typeName = WormholeMessage.$typeName;
  readonly $fullTypeName: `${string}::publish_message::WormholeMessage`;
  readonly $typeArgs: [];
  readonly $isPhantom: typeof WormholeMessage.$isPhantom = WormholeMessage.$isPhantom;
  ...
  static reified(): WormholeMessageReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(WormholeMessage.$typeName, ...[]) as `${string}::publish_message::WormholeMessage`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => WormholeMessage.fromCoreObject(obj),
...
export function isMessageTicket(type: string): boolean {
  type = compressSuiType(type);
  return type === `${getTypeOrigin("wormhole", "publish_message::MessageTicket")}::publish_message::MessageTicket`;
}
...
export class MessageTicket implements StructClass {
  ...
  static get $typeName(): `${string}::publish_message::MessageTicket` {
    return `${getTypeOrigin("wormhole", "publish_message::MessageTicket")}::publish_message::MessageTicket` as const;
  }
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  readonly $typeArgs: [];
  readonly $isPhantom: typeof MessageTicket.$isPhantom = MessageTicket.$isPhantom;
  ...
  static reified(): MessageTicketReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(MessageTicket.$typeName, ...[]) as `${string}::publish_message::MessageTicket`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => MessageTicket.fromCoreObject(obj),
