...
export class UQ32_32 implements StructClass {
  ...
  static reified(): UQ32_32Reified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(UQ32_32.$typeName, ...[]) as `0x1::uq32_32::UQ32_32`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => UQ32_32.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): UQ32_32 {
    if (json.$typeName !== UQ32_32.$typeName) {
      throw new Error(`not a UQ32_32 json object: expected '${UQ32_32.$typeName}' but got '${json.$typeName}'`);
    }
