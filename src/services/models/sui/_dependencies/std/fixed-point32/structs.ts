...
export class FixedPoint32 implements StructClass {
  ...
  static readonly $typeName: `0x1::fixed_point32::FixedPoint32` = `0x1::fixed_point32::FixedPoint32` as const;
  ...
  private constructor(typeArgs: [], fields: FixedPoint32Fields) {
    this.$fullTypeName = composeSuiType(FixedPoint32.$typeName, ...typeArgs) as `0x1::fixed_point32::FixedPoint32`;
  ...
  static reified(): FixedPoint32Reified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(FixedPoint32.$typeName, ...[]) as `0x1::fixed_point32::FixedPoint32`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => FixedPoint32.fromCoreObject(obj),
