...
export class Extension implements StructClass {
  ...
  static readonly $typeName: `0x2::kiosk_extension::Extension` = `0x2::kiosk_extension::Extension` as const;
  ...
  private constructor(typeArgs: [], fields: ExtensionFields) {
    this.$fullTypeName = composeSuiType(Extension.$typeName, ...typeArgs) as `0x2::kiosk_extension::Extension`;
  ...
  static reified(): ExtensionReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(Extension.$typeName, ...[]) as `0x2::kiosk_extension::Extension`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => Extension.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): Extension {
    if (json.$typeName !== Extension.$typeName) {
      throw new Error(`not a Extension json object: expected '${Extension.$typeName}' but got '${json.$typeName}'`);
    }
...
export class ExtensionKey<Ext extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::kiosk_extension::ExtensionKey` = `0x2::kiosk_extension::ExtensionKey` as const;
  ...
  static reified<Ext extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => ExtensionKey.fromCoreObject(Ext, obj),
  ...
  static fromJSON<Ext extends PhantomReified<PhantomTypeArgument>>(
    ...
    assertReifiedTypeArgsMatch(composeSuiType(ExtensionKey.$typeName, ...[extractType(typeArg)]), json.$typeArgs, [
      typeArg,
    ]);
