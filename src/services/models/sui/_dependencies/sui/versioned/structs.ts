...
export class Versioned implements StructClass {
  ...
  private constructor(typeArgs: [], fields: VersionedFields) {
    this.$fullTypeName = composeSuiType(Versioned.$typeName, ...typeArgs) as `0x2::versioned::Versioned`;
  ...
  static reified(): VersionedReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(Versioned.$typeName, ...[]) as `0x2::versioned::Versioned`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => Versioned.fromCoreObject(obj),
  ...
  static get bcs(): ReturnType<typeof Versioned.instantiateBcs> {
  ...
  static fromJSON(json: Record<string, any>): Versioned {
    if (json.$typeName !== Versioned.$typeName) {
      throw new Error(`not a Versioned json object: expected '${Versioned.$typeName}' but got '${json.$typeName}'`);
    }
...
export class VersionChangeCap implements StructClass {
  ...
  static readonly $typeName: `0x2::versioned::VersionChangeCap` = `0x2::versioned::VersionChangeCap` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  private constructor(typeArgs: [], fields: VersionChangeCapFields) {
    this.$fullTypeName = composeSuiType(VersionChangeCap.$typeName, ...typeArgs) as `0x2::versioned::VersionChangeCap`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): VersionChangeCapReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(VersionChangeCap.$typeName, ...[]) as `0x2::versioned::VersionChangeCap`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => VersionChangeCap.fromCoreObject(obj),
  ...
  static get bcs(): ReturnType<typeof VersionChangeCap.instantiateBcs> {
