...
export class TableVec<Element extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<Element extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TableVec.fromCoreObject(Element, obj),
  ...
  static fromFieldsWithTypes<Element extends PhantomReified<PhantomTypeArgument>>(
    ...
    return TableVec.reified(typeArg).new({
      contents: decodeFromFieldsWithTypes(Table.reified(phantom("u64"), typeArg), item.fields.contents),
    });
  }
  ...
  static fromJSON<Element extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (json.$typeName !== TableVec.$typeName) {
      throw new Error(`not a TableVec json object: expected '${TableVec.$typeName}' but got '${json.$typeName}'`);
    }
    assertReifiedTypeArgsMatch(composeSuiType(TableVec.$typeName, ...[extractType(typeArg)]), json.$typeArgs, [
      typeArg,
    ]);
