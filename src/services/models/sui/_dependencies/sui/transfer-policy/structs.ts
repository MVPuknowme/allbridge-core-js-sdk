...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::transfer_policy::TransferRequest` = `0x2::transfer_policy::TransferRequest` as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TransferRequest.fromCoreObject(T, obj),
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::transfer_policy::TransferPolicy` = `0x2::transfer_policy::TransferPolicy` as const;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TransferPolicyReified<ToPhantomTypeArgument<T>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TransferPolicy.fromCoreObject(T, obj),
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TransferPolicyCap.fromCoreObject(T, obj),
      ...
      fetch: async (client: ClientWithCoreApi, id: string) => TransferPolicyCap.fetch(client, T, id),
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TransferPolicyCreated.fromCoreObject(T, obj),
      ...
      fetch: async (client: ClientWithCoreApi, id: string) => TransferPolicyCreated.fetch(client, T, id),
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass {
  ...
  readonly $typeArgs: [PhantomToTypeStr<T>];
  readonly $isPhantom: typeof TransferPolicyDestroyed.$isPhantom = TransferPolicyDestroyed.$isPhantom;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TransferPolicyDestroyed.fromCoreObject(T, obj),
      ...
      fetch: async (client: ClientWithCoreApi, id: string) => TransferPolicyDestroyed.fetch(client, T, id),
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::transfer_policy::RuleKey` = `0x2::transfer_policy::RuleKey` as const;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): RuleKeyReified<ToPhantomTypeArgument<T>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => RuleKey.fromCoreObject(T, obj),
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (json.$typeName !== RuleKey.$typeName) {
      throw new Error(`not a RuleKey json object: expected '${RuleKey.$typeName}' but got '${json.$typeName}'`);
    }
