...
export class Scalar implements StructClass {
  ...
  static reified(): ScalarReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(Scalar.$typeName, ...[]) as `0x2::bls12381::Scalar`;
      },
      typeArgs: [] as [],
  ...
  static fromJSON(json: Record<string, any>): Scalar {
    if (json.$typeName !== Scalar.$typeName) {
      throw new Error(`not a Scalar json object: expected '${Scalar.$typeName}' but got '${json.$typeName}'`);
    }
...
export class G1 implements StructClass {
  ...
  static reified(): G1Reified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(G1.$typeName, ...[]) as `0x2::bls12381::G1`;
      },
      typeArgs: [] as [],
  ...
  static fromJSON(json: Record<string, any>): G1 {
    if (json.$typeName !== G1.$typeName) {
      throw new Error(`not a G1 json object: expected '${G1.$typeName}' but got '${json.$typeName}'`);
    }
...
export class G2 implements StructClass {
  ...
  static reified(): G2Reified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(G2.$typeName, ...[]) as `0x2::bls12381::G2`;
      },
      typeArgs: [] as [],
  ...
  static fromJSON(json: Record<string, any>): G2 {
    if (json.$typeName !== G2.$typeName) {
      throw new Error(`not a G2 json object: expected '${G2.$typeName}' but got '${json.$typeName}'`);
    }
...
export class GT implements StructClass {
  ...
  static reified(): GTReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(GT.$typeName, ...[]) as `0x2::bls12381::GT`;
      },
      typeArgs: [] as [],
  ...
  static fromJSON(json: Record<string, any>): GT {
    if (json.$typeName !== GT.$typeName) {
      throw new Error(`not a GT json object: expected '${GT.$typeName}' but got '${json.$typeName}'`);
    }
...
export class UncompressedG1 implements StructClass {
  ...
  static readonly $typeName: `0x2::bls12381::UncompressedG1` = `0x2::bls12381::UncompressedG1` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  private constructor(typeArgs: [], fields: UncompressedG1Fields) {
    this.$fullTypeName = composeSuiType(UncompressedG1.$typeName, ...typeArgs) as `0x2::bls12381::UncompressedG1`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): UncompressedG1Reified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(UncompressedG1.$typeName, ...[]) as `0x2::bls12381::UncompressedG1`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => UncompressedG1.fromCoreObject(obj),
