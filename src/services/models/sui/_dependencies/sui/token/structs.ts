...
export class Token<T extends PhantomTypeArgument> implements StructClass {
  ...
  private constructor(typeArgs: [PhantomToTypeStr<T>], fields: TokenFields<T>) {
    this.$fullTypeName = composeSuiType(Token.$typeName, ...typeArgs) as `0x2::token::Token<${PhantomToTypeStr<T>}>`;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TokenReified<ToPhantomTypeArgument<T>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => Token.fromCoreObject(T, obj),
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (json.$typeName !== Token.$typeName) {
      throw new Error(`not a Token json object: expected '${Token.$typeName}' but got '${json.$typeName}'`);
    }
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TokenPolicyCapReified<ToPhantomTypeArgument<T>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TokenPolicyCap.fromCoreObject(T, obj),
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): TokenPolicyReified<ToPhantomTypeArgument<T>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TokenPolicy.fromCoreObject(T, obj),
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (json.$typeName !== TokenPolicy.$typeName) {
      throw new Error(`not a TokenPolicy json object: expected '${TokenPolicy.$typeName}' but got '${json.$typeName}'`);
    }
    assertReifiedTypeArgsMatch(composeSuiType(TokenPolicy.$typeName, ...[extractType(typeArg)]), json.$typeArgs, [
      typeArg,
    ]);
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): ActionRequestReified<ToPhantomTypeArgument<T>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => ActionRequest.fromCoreObject(T, obj),
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::token::TokenPolicyCreated` = `0x2::token::TokenPolicyCreated` as const;
  static readonly $numTypeParams = 1;
  static readonly $isPhantom = [true] as const;
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => TokenPolicyCreated.fromCoreObject(T, obj),
      ...
      fetch: async (client: ClientWithCoreApi, id: string) => TokenPolicyCreated.fetch(client, T, id),
