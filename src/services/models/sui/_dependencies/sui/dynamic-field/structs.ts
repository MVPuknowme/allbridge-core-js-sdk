...
export class Field<Name extends TypeArgument, Value extends TypeArgument> implements StructClass {
  ...
  static reified<Name extends Reified<TypeArgument, any>, Value extends Reified<TypeArgument, any>>(
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => Field.fromCoreObject([Name, Value], obj),
      ...
      fetch: async (client: ClientWithCoreApi, id: string) => Field.fetch(client, [Name, Value], id),
  ...
  static fromJSON<Name extends Reified<TypeArgument, any>, Value extends Reified<TypeArgument, any>>(
    ...
    if (json.$typeName !== Field.$typeName) {
      throw new Error(`not a Field json object: expected '${Field.$typeName}' but got '${json.$typeName}'`);
    }
  ...
  static fromCoreObject<Name extends Reified<TypeArgument, any>, Value extends Reified<TypeArgument, any>>(
    typeArgs: [Name, Value],
