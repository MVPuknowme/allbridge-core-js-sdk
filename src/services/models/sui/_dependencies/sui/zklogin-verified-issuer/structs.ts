...
export class VerifiedIssuer implements StructClass {
  ...
  static reified(): VerifiedIssuerReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(VerifiedIssuer.$typeName, ...[]) as `0x2::zklogin_verified_issuer::VerifiedIssuer`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => VerifiedIssuer.fromCoreObject(obj),
