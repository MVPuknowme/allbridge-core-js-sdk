...
export class Random implements StructClass {
  ...
  static reified(): RandomReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(Random.$typeName, ...[]) as `0x2::random::Random`;
      },
      typeArgs: [] as [],
  ...
  static fromJSON(json: Record<string, any>): Random {
    if (json.$typeName !== Random.$typeName) {
      throw new Error(`not a Random json object: expected '${Random.$typeName}' but got '${json.$typeName}'`);
    }
...
export class RandomInner implements StructClass {
  ...
  private constructor(typeArgs: [], fields: RandomInnerFields) {
    this.$fullTypeName = composeSuiType(RandomInner.$typeName, ...typeArgs) as `0x2::random::RandomInner`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): RandomInnerReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(RandomInner.$typeName, ...[]) as `0x2::random::RandomInner`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => RandomInner.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): RandomInner {
    if (json.$typeName !== RandomInner.$typeName) {
      throw new Error(`not a RandomInner json object: expected '${RandomInner.$typeName}' but got '${json.$typeName}'`);
    }
...
export class RandomGenerator implements StructClass {
  ...
  static readonly $typeName: `0x2::random::RandomGenerator` = `0x2::random::RandomGenerator` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  private constructor(typeArgs: [], fields: RandomGeneratorFields) {
    this.$fullTypeName = composeSuiType(RandomGenerator.$typeName, ...typeArgs) as `0x2::random::RandomGenerator`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): RandomGeneratorReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(RandomGenerator.$typeName, ...[]) as `0x2::random::RandomGenerator`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => RandomGenerator.fromCoreObject(obj),
