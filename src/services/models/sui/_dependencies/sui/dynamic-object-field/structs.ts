...
export class Wrapper<Name extends TypeArgument> implements StructClass {
  ...
  static readonly $typeName: `0x2::dynamic_object_field::Wrapper` = `0x2::dynamic_object_field::Wrapper` as const;
  ...
  static reified<Name extends Reified<TypeArgument, any>>(Name: Name): WrapperReified<ToTypeArgument<Name>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => Wrapper.fromCoreObject(Name, obj),
  ...
  static fromJSON<Name extends Reified<TypeArgument, any>>(
    ...
    if (json.$typeName !== Wrapper.$typeName) {
      throw new Error(`not a Wrapper json object: expected '${Wrapper.$typeName}' but got '${json.$typeName}'`);
    }
