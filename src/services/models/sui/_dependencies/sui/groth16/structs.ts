...
export class Curve implements StructClass {
  ...
  static reified(): CurveReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(Curve.$typeName, ...[]) as `0x2::groth16::Curve`;
      },
      typeArgs: [] as [],
  ...
  static fromJSON(json: Record<string, any>): Curve {
    if (json.$typeName !== Curve.$typeName) {
      throw new Error(`not a Curve json object: expected '${Curve.$typeName}' but got '${json.$typeName}'`);
    }
...
export class PreparedVerifyingKey implements StructClass {
  ...
  static readonly $typeName: `0x2::groth16::PreparedVerifyingKey` = `0x2::groth16::PreparedVerifyingKey` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  static reified(): PreparedVerifyingKeyReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(PreparedVerifyingKey.$typeName, ...[]) as `0x2::groth16::PreparedVerifyingKey`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => PreparedVerifyingKey.fromCoreObject(obj),
      ...
      fetch: async (client: ClientWithCoreApi, id: string) => PreparedVerifyingKey.fetch(client, id),
  ...
  static fromFieldsWithTypes(item: FieldsWithTypes): PreparedVerifyingKey {
    ...
    return PreparedVerifyingKey.reified().new({
      ...
      alphaG1BetaG2Bytes: decodeFromFieldsWithTypes(vector("u8"), item.fields.alpha_g1_beta_g2_bytes),
...
export class PublicProofInputs implements StructClass {
  ...
  static readonly $typeName: `0x2::groth16::PublicProofInputs` = `0x2::groth16::PublicProofInputs` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  private constructor(typeArgs: [], fields: PublicProofInputsFields) {
    this.$fullTypeName = composeSuiType(PublicProofInputs.$typeName, ...typeArgs) as `0x2::groth16::PublicProofInputs`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): PublicProofInputsReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(PublicProofInputs.$typeName, ...[]) as `0x2::groth16::PublicProofInputs`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => PublicProofInputs.fromCoreObject(obj),
...
export class ProofPoints implements StructClass {
  ...
  private constructor(typeArgs: [], fields: ProofPointsFields) {
    this.$fullTypeName = composeSuiType(ProofPoints.$typeName, ...typeArgs) as `0x2::groth16::ProofPoints`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): ProofPointsReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(ProofPoints.$typeName, ...[]) as `0x2::groth16::ProofPoints`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => ProofPoints.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): ProofPoints {
    if (json.$typeName !== ProofPoints.$typeName) {
      throw new Error(`not a ProofPoints json object: expected '${ProofPoints.$typeName}' but got '${json.$typeName}'`);
    }
