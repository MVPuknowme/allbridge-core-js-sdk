...
export class DenyList implements StructClass {
  ...
  private constructor(typeArgs: [], fields: DenyListFields) {
    this.$fullTypeName = composeSuiType(DenyList.$typeName, ...typeArgs) as `0x2::deny_list::DenyList`;
  ...
  static reified(): DenyListReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(DenyList.$typeName, ...[]) as `0x2::deny_list::DenyList`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => DenyList.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): DenyList {
    if (json.$typeName !== DenyList.$typeName) {
      throw new Error(`not a DenyList json object: expected '${DenyList.$typeName}' but got '${json.$typeName}'`);
    }
...
export class ConfigWriteCap implements StructClass {
  ...
  static readonly $typeName: `0x2::deny_list::ConfigWriteCap` = `0x2::deny_list::ConfigWriteCap` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  private constructor(typeArgs: [], fields: ConfigWriteCapFields) {
    this.$fullTypeName = composeSuiType(ConfigWriteCap.$typeName, ...typeArgs) as `0x2::deny_list::ConfigWriteCap`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): ConfigWriteCapReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(ConfigWriteCap.$typeName, ...[]) as `0x2::deny_list::ConfigWriteCap`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => ConfigWriteCap.fromCoreObject(obj),
...
export class ConfigKey implements StructClass {
  ...
  private constructor(typeArgs: [], fields: ConfigKeyFields) {
    this.$fullTypeName = composeSuiType(ConfigKey.$typeName, ...typeArgs) as `0x2::deny_list::ConfigKey`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): ConfigKeyReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(ConfigKey.$typeName, ...[]) as `0x2::deny_list::ConfigKey`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => ConfigKey.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): ConfigKey {
    if (json.$typeName !== ConfigKey.$typeName) {
      throw new Error(`not a ConfigKey json object: expected '${ConfigKey.$typeName}' but got '${json.$typeName}'`);
    }
...
export class AddressKey implements StructClass {
  ...
  private constructor(typeArgs: [], fields: AddressKeyFields) {
    this.$fullTypeName = composeSuiType(AddressKey.$typeName, ...typeArgs) as `0x2::deny_list::AddressKey`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): AddressKeyReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(AddressKey.$typeName, ...[]) as `0x2::deny_list::AddressKey`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => AddressKey.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): AddressKey {
    if (json.$typeName !== AddressKey.$typeName) {
      throw new Error(`not a AddressKey json object: expected '${AddressKey.$typeName}' but got '${json.$typeName}'`);
    }
...
export class GlobalPauseKey implements StructClass {
  ...
  static readonly $typeName: `0x2::deny_list::GlobalPauseKey` = `0x2::deny_list::GlobalPauseKey` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  private constructor(typeArgs: [], fields: GlobalPauseKeyFields) {
    this.$fullTypeName = composeSuiType(GlobalPauseKey.$typeName, ...typeArgs) as `0x2::deny_list::GlobalPauseKey`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): GlobalPauseKeyReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(GlobalPauseKey.$typeName, ...[]) as `0x2::deny_list::GlobalPauseKey`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => GlobalPauseKey.fromCoreObject(obj),
...
export class PerTypeConfigCreated implements StructClass {
  ...
  static readonly $typeName: `0x2::deny_list::PerTypeConfigCreated` = `0x2::deny_list::PerTypeConfigCreated` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  static reified(): PerTypeConfigCreatedReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(PerTypeConfigCreated.$typeName, ...[]) as `0x2::deny_list::PerTypeConfigCreated`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => PerTypeConfigCreated.fromCoreObject(obj),
      ...
      fetch: async (client: ClientWithCoreApi, id: string) => PerTypeConfigCreated.fetch(client, id),
...
export class PerTypeList implements StructClass {
  ...
  private constructor(typeArgs: [], fields: PerTypeListFields) {
    this.$fullTypeName = composeSuiType(PerTypeList.$typeName, ...typeArgs) as `0x2::deny_list::PerTypeList`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): PerTypeListReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(PerTypeList.$typeName, ...[]) as `0x2::deny_list::PerTypeList`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => PerTypeList.fromCoreObject(obj),
  ...
  static fromFields(fields: Record<string, any>): PerTypeList {
    return PerTypeList.reified().new({
      id: decodeFromFields(UID.reified(), fields.id),
      deniedCount: decodeFromFields(Table.reified(phantom("address"), phantom("u64")), fields.denied_count),
  ...
  static fromJSONField(field: any): PerTypeList {
    return PerTypeList.reified().new({
      id: decodeFromJSONField(UID.reified(), field.id),
      deniedCount: decodeFromJSONField(Table.reified(phantom("address"), phantom("u64")), field.deniedCount),
  ...
  static fromJSON(json: Record<string, any>): PerTypeList {
    if (json.$typeName !== PerTypeList.$typeName) {
      throw new Error(`not a PerTypeList json object: expected '${PerTypeList.$typeName}' but got '${json.$typeName}'`);
    }
