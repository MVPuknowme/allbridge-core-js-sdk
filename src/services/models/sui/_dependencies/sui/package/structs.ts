...
export class Publisher implements StructClass {
  ...
  private constructor(typeArgs: [], fields: PublisherFields) {
    this.$fullTypeName = composeSuiType(Publisher.$typeName, ...typeArgs) as `0x2::package::Publisher`;
  ...
  static reified(): PublisherReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(Publisher.$typeName, ...[]) as `0x2::package::Publisher`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => Publisher.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): Publisher {
    if (json.$typeName !== Publisher.$typeName) {
      throw new Error(`not a Publisher json object: expected '${Publisher.$typeName}' but got '${json.$typeName}'`);
    }
...
export class UpgradeCap implements StructClass {
  ...
  private constructor(typeArgs: [], fields: UpgradeCapFields) {
    this.$fullTypeName = composeSuiType(UpgradeCap.$typeName, ...typeArgs) as `0x2::package::UpgradeCap`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): UpgradeCapReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(UpgradeCap.$typeName, ...[]) as `0x2::package::UpgradeCap`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => UpgradeCap.fromCoreObject(obj),
  ...
  static fromJSON(json: Record<string, any>): UpgradeCap {
    if (json.$typeName !== UpgradeCap.$typeName) {
      throw new Error(`not a UpgradeCap json object: expected '${UpgradeCap.$typeName}' but got '${json.$typeName}'`);
    }
...
export class UpgradeTicket implements StructClass {
  ...
  private constructor(typeArgs: [], fields: UpgradeTicketFields) {
    this.$fullTypeName = composeSuiType(UpgradeTicket.$typeName, ...typeArgs) as `0x2::package::UpgradeTicket`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): UpgradeTicketReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(UpgradeTicket.$typeName, ...[]) as `0x2::package::UpgradeTicket`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => UpgradeTicket.fromCoreObject(obj),
...
export class UpgradeReceipt implements StructClass {
  ...
  static readonly $typeName: `0x2::package::UpgradeReceipt` = `0x2::package::UpgradeReceipt` as const;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;
  ...
  private constructor(typeArgs: [], fields: UpgradeReceiptFields) {
    this.$fullTypeName = composeSuiType(UpgradeReceipt.$typeName, ...typeArgs) as `0x2::package::UpgradeReceipt`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): UpgradeReceiptReified {
    ...
    return {
      ...
      get fullTypeName() {
        return composeSuiType(UpgradeReceipt.$typeName, ...[]) as `0x2::package::UpgradeReceipt`;
      },
      typeArgs: [] as [],
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => UpgradeReceipt.fromCoreObject(obj),
