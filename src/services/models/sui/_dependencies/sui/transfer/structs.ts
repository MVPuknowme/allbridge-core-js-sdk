...
export class Receiving<T extends PhantomTypeArgument> implements StructClass {
  ...
  static reified<T extends PhantomReified<PhantomTypeArgument>>(T: T): ReceivingReified<ToPhantomTypeArgument<T>> {
    ...
    return {
      ...
      fromCoreObject: (obj: SuiClientTypes.Object<{ content: true }>) => Receiving.fromCoreObject(T, obj),
  ...
  static fromJSON<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (json.$typeName !== Receiving.$typeName) {
      throw new Error(`not a Receiving json object: expected '${Receiving.$typeName}' but got '${json.$typeName}'`);
    }
    assertReifiedTypeArgsMatch(composeSuiType(Receiving.$typeName, ...[extractType(typeArg)]), json.$typeArgs, [
      typeArg,
    ]);
  ...
  static fromCoreObject<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    if (!isReceiving(obj.type)) {
      throw new Error(`object at ${obj.objectId} is not a Receiving object`);
    }
  ...
  static async fetch<T extends PhantomReified<PhantomTypeArgument>>(
    ...
    return Receiving.fromBcs(typeArg, object.content);
  }
}
